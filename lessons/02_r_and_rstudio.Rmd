...
The source you work on will usually be scripts, text files that hold the code you write or in our case R markdown that can hold code, documentation, etc.  We will work with our `.Rmd` files and the console during this workshop.  To create a new script you use "File:New File:R Markdown".
...
When working with R Markdown files we usually want to render those to an output format such as html or pdf.  Again, there are several ways to do that.  The easiest is it use the knit or preview button.
